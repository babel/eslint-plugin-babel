...
function isDecoratorMacro(node) {
  return node.parent &&
...
module.exports = function(context) {
    ...
    var allowDecoratorMacro = options && options.allowDecoratorMacro === true || false;
    ...
    return {
        ...
        "Program:exit": function(/* node */) {
            ...
            globalScope.through.forEach(function(ref) {
                ...
                if (allowDecoratorMacro && isDecoratorMacro(ref.identifier)) {
                    return;
                }
