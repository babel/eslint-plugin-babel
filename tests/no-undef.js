...
var rule = require('../rules/no-undef'),
...
ruleTester.run("no-undef", rule, {
    valid: [
        ...
        // Allow decorator macro test case
        { code: "function required() {}; var obj = { @required foo };", parser: "babel-eslint", options: [{ allowDecoratorMacro: true }]  }
    ],
    invalid: [
        ...
        // Allow decorator macro test case
        { code: "function required() {}; var obj = { @required foo };", parser: "babel-eslint", errors: [{ message: "\"foo\" is not defined." }] }
    ]
});
